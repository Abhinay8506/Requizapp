...
function initApp() {
    ...
    quiz = new Quiz(
        "Welcome to Goswami's Quiz World",
        `Your ultimate destination for fun and engaging quizzes.Dive into an engaging and interactive way to test and expand your JavaScript knowledge. Whether you're a beginner looking to solidify your basics or an advanced programmer aiming to challenge your skills.`,
        70,
        questions);
